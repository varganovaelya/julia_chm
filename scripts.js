    ...
    `,
        "test": {
            ...
            },
            {
				...
				{
		    "question": "Что такое неустранимая погрешность?",
    		"answers": [
        		{
          		  "text": "Погрешность, возникающая из-за неточности исходной информации (например, неточности измерений).",
          		  "correct": true
       			 },
      			 {
           		 "text": "Погрешность, возникающая из-за округления чисел при вычислениях.",
           		 "correct": false
     			 },
        		 {
                 "text": "Погрешность, возникающая из-за несоответствия математической модели реальному объекту.",
                 "correct": false
       			 }
			    ],
  				  "type": "multiple"
...
{
    "question": "Как определяется предельная абсолютная погрешность приближённого числа, если она не указана в условии задачи?",
    "answers": [
        {
            "text": "Принимается равной половине последнего значащего разряда.",
            "correct": true
        },
        {
            "text": "Принимается равной единице последнего значащего разряда.",
            "correct": false
        },
        {
            "text": "Принимается равной нулю.",
            "correct": false
        },
        {
            "text": "Принимается равной десяти процентам от числа.",
            "correct": false
        }
    ],
    "type": "single"
...
{
    "question": "Какими единицами измерения измеряется предельная относительная погрешность?",
    "answers": [
        {
            "text": "Это безразмерная величина, может выражаться в процентах.",
            "correct": true
        },
        {
            "text": "Измеряется в тех же единицах, что и сама величина.",
        ...
        {
            "text": "Измеряется в квадратных единицах.",
            "correct": false
        },
        {
            "text": "Измеряется в логарифмических единицах.",
            "correct": false
        }
    ],
    "type": "single"
...
{
    "question": "Какая погрешность лучше характеризует точность результата?",
    "answers": [
        {
            "text": "Предельная относительная погрешность, так как показывает какую часть самого числа составляет погрешность.",
            "correct": true
        },
        {
            "text": "Абсолютная погрешность, так как показывает точную разницу.",
            "correct": false
        },
        {
            "text": "Неустранимая погрешность.",
            "correct": false
        },
        {
            "text": "Погрешность метода.",
            "correct": false
        }
    ],
    "type": "single"
...
{
    "question": "В чём заключается основная (прямая) задача теории погрешностей?",
    "answers": [
        {
            "text": "Указание области неопределённости результата, то есть определение по известным погрешностям параметров погрешности функции от этих параметров.",
            "correct": true
        },
        {
            "text": "Уменьшение погрешности вычислений за счёт выбора более точного метода.",
            "correct": false
        },
        {
            "text": "Полное устранение всех видов погрешностей.",
            "correct": false
        },
        {
            "text": "Округление чисел до нужного знака.",
            "correct": false
        }
    ],
    "type": "single"
...
`,
      ...
      },
      {
        ...
        "type": "multiple"
				...
				{
    "question": "Какой метод уточнения корней также называют методом биссекции?",
    "answers": [
        {
...
{
    "question": "Какие условия необходимы для сходимости метода Ньютона на отрезке?",
    "answers": [
        {
            "text": "Функция должна быть непрерывна, на концах отрезка иметь разные знаки, а первая и вторая производные должны сохранять постоянный знак",
            "correct": true
        },
        {
            "text": "Достаточно, чтобы функция была непрерывна на отрезке",
            "correct": false
        },
        {
            "text": "Функция должна быть чётной",
            "correct": false
        },
        {
            "text": "Функция должна быть периодической",
            "correct": false
        }
    ],
    "type": "single"
...
{
    "question": "Какую скорость сходимости имеет метод Ньютона?",
    "answers": [
        {
            "text": "Квадратичную сходимость",
            "correct": true
        },
        {
            "text": "Линейную сходимость",
            "correct": false
        },
        {
            "text": "Логарифмическую сходимость",
            "correct": false
        },
        {
            "text": "Медленную сходимость",
            "correct": false
        }
    ],
    "type": "single"
...
{
    "question": "В чём заключается геометрическая интерпретация метода Ньютона?",
    "answers": [
        {
            "text": "На каждом шаге проводится касательная к графику функции, и следующее приближение находится как точка пересечения касательной с осью X",
            "correct": true
        },
        {
            "text": "Отрезок делится пополам и выбирается та половина, где функция меняет знак",
            "correct": false
        },
        {
            "text": "Строится ломаная, приближающаяся к точке пересечения двух графиков",
            "correct": false
        },
        {
            "text": "Проводится хорда, соединяющая две точки графика",
            "correct": false
        }
    ],
    "type": "single"
...
{
    "question": "В каком случае метод простой итерации будет расходиться?",
    "answers": [
        {
            "text": "Когда модуль производной функции в окрестности корня больше единицы",
            "correct": true
        },
        {
            "text": "Когда модуль производной функции в окрестности корня меньше единицы",
            "correct": false
        },
        {
            "text": "Когда функция является чётной",
            "correct": false
        },
        {
            "text": "Когда функция является нечётной",
            "correct": false
        }
    ],
    "type": "single"
...
`,
	"test": {
	  ...
	  {
    "question": "Почему прямые методы решения СЛАУ называют точными, но на практике точное решение всё равно не достигается?",
    "answers": [
        {
            "text": "Потому что коэффициенты системы являются приближёнными числами, а при вычислениях на компьютере возникают погрешности округления.",
            "correct": true
        },
        {
            "text": "Потому что прямые методы содержат принципиальную ошибку в алгоритме.",
            "correct": false
        },
        {
            "text": "Потому что прямые методы не предназначены для точного решения.",
            "correct": false
        }
    ],
    "type": "single"
...
{
    "question": "В чём заключается преимущество итерационных методов по сравнению с прямыми методами решения СЛАУ?",
    "answers": [
        {
            "text": "Погрешности окончательных результатов не накапливаются, так как точность на каждой итерации зависит только от предыдущей итерации.",
            "correct": true
        },
        {
            "text": "Они всегда дают точное решение за один шаг.",
            "correct": false
        },
        {
            "text": "Они не требуют задания начального приближения.",
            "correct": false
        }
    ],
    "type": "single"
...
{
    "question": "Что происходит на этапе прямого хода в методе Гаусса?",
    "answers": [
        {
            "text": "Последовательное исключение неизвестных переменных, приводящее систему к треугольному виду.",
            "correct": true
        },
        {
            "text": "Последовательное вычисление значений неизвестных из треугольной системы.",
            "correct": false
        },
        {
            "text": "Перестановка уравнений в случайном порядке.",
            "correct": false
        }
    ],
    "type": "single"
...
{
    "question": "Какие две процедуры составляют метод Гаусса?",
    "answers": [
        {
            "text": "Прямой ход и обратный ход.",
            "correct": true
        },
        {
            "text": "Итерация и проверка сходимости.",
            "correct": false
        },
        {
            "text": "Приведение к нормальному виду и подстановка.",
            "correct": false
        }
    ],
    "type": "single"
...
{
    "question": "Какое важное требование предъявляется к матрице коэффициентов для применения итерационных методов (Якоби и Зейделя)?",
    "answers": [
        {
            "text": "Диагональные элементы матрицы должны быть отличны от нуля.",
            "correct": true
        },
        {
            "text": "Все коэффициенты матрицы должны быть положительными.",
            "correct": false
        },
        {
            "text": "Матрица должна быть симметричной.",
            "correct": false
        }
    ],
    "type": "single"
...
`,
	"test": {
	  ...
	  {
    "question": "Каковы основные недостатки метода Ньютона для решения систем нелинейных уравнений?",
    "answers": [
        {
            "text": "Необходимость задавать достаточно хорошее начальное приближение.",
            "correct": true
        },
        {
            "text": "Отсутствие глобальной сходимости для многих задач.",
            "correct": true
        },
        {
            "text": "Необходимость вычисления матрицы Якоби на каждой итерации.",
            "correct": true
        },
        {
            "text": "Метод всегда сходится при любом начальном приближении.",
            "correct": false
        }
    ],
    "type": "multiple"
...
{
    "question": "Какое основное преимущество метода Ньютона для решения систем нелинейных уравнений?",
    "answers": [
        {
            "text": "Квадратичная сходимость при хорошем начальном приближении и невырожденности матрицы Якоби.",
            "correct": true
        },
        {
            "text": "Не требуется вычислять производные функций.",
            "correct": false
        },
        {
            "text": "Метод всегда сходится за одну итерацию.",
            "correct": false
        }
    ],
    "type": "single"
...
{
    "question": "Каким образом можно выбрать начальное приближение для системы двух нелинейных уравнений?",
    "answers": [
        {
            "text": "С помощью графического способа — построения кривых на плоскости и определения точки их пересечения.",
            "correct": true
        },
        {
            "text": "Методом Гаусса.",
...
{
    "question": "Что является основным отличием метода простой итерации для систем нелинейных уравнений от метода Ньютона?",
    "answers": [
        {
            "text": "Метод простой итерации не требует вычисления производных и решения систем линейных уравнений на каждом шаге.",
            "correct": true
        },
        {
            "text": "Метод простой итерации требует более точного начального приближения, чем метод Ньютона.",
            "correct": false
        },
        {
            "text": "Метод простой итерации всегда сходится быстрее метода Ньютона.",
            "correct": false
        }
    ],
    "type": "single"
...
{
    "question": "При каком условии итерационный процесс метода простой итерации для систем нелинейных уравнений считается завершённым?",
    "answers": [
        {
            "text": "Когда максимальная разность между двумя последовательными приближениями всех неизвестных становится меньше заданной точности.",
            "correct": true
        },
        {
            "text": "Когда выполнено заранее заданное фиксированное число итераций.",
            "correct": false
        },
        {
            "text": "Когда начальное приближение совпадает с решением.",
            "correct": false
        }
    ],
    "type": "single"
...
`,
	"test": {
	  ...
	  {
    "question": "Какой вид аппроксимации следует использовать, если значения исследуемой зависимости характеризуются постоянным изменением скорости роста (например, график равноускоренного движения автомобиля)?",
    "answers": [
        {
            "text": "Степенная аппроксимация.",
            "correct": true
        ...
        {
            "text": "Логарифмическая аппроксимация.",
            "correct": false
        },
        {
            "text": "Экспоненциальная аппроксимация.",
...
{
    "question": "В каком случае применяется логарифмическая аппроксимация?",
    "answers": [
        {
            "text": "Когда значения исследуемой зависимости вначале быстро меняются, а затем постепенно стабилизируются.",
            "correct": true
        },
        {
            "text": "Когда значения исследуемой зависимости увеличиваются или убывают с постоянной скоростью.",
            "correct": false
        },
        {
            "text": "Когда исследуемая характеристика имеет несколько ярко выраженных экстремумов.",
...
{
    "question": "Какие из перечисленных видов аппроксимации недоступны, если значения аргумента функции x содержат отрицательные или нулевые значения?",
    "answers": [
        {
            "text": "Логарифмическая аппроксимация.",
            "correct": true
        ...
        {
            "text": "Полиномиальная аппроксимация.",
            "correct": false
        }
    ],
    "type": "multiple"
...
{
    "question": "Какой вид аппроксимации используется, когда скорость изменения данных непрерывно возрастает?",
    "answers": [
        {
            "text": "Экспоненциальная аппроксимация.",
            "correct": true
...
{
    "question": "Что представляет собой метод квадратичной аппроксимации?",
    "answers": [
        {
            "text": "Метод, в котором функция аппроксимируется полиномом второй степени в окрестности минимума, а точка минимума полинома принимается за приближение к точке минимума исходной функции.",
            "correct": true
        },
        {
            "text": "Метод, в котором функция аппроксимируется прямой линией.",
            "correct": false
        },
        {
            "text": "Метод, в котором функция аппроксимируется логарифмической кривой.",
            "correct": false
        },
        {
            "text": "Метод, в котором функция аппроксимируется показательной кривой.",
            "correct": false
        }
    ],
    "type": "single"
...
`,
	"test": {
	  ...
	  {
    "question": "Какой вид интерполяции применяют для функций, заданных небольшим количеством точек, и почему?",
    "answers": [
        {
            "text": "Глобальную интерполяцию, потому что при увеличении количества точек увеличивается порядок полинома, что отрицательно сказывается на гладкости функции.",
            "correct": true
        },
        {
            "text": "Локальную интерполяцию, потому что она дает более точные результаты.",
            "correct": false
        },
        {
            "text": "Интерполяцию кубическими сплайнами, потому что она самая простая.",
            "correct": false
        },
        {
            "text": "Линейную интерполяцию, потому что она не требует вычислений.",
            "correct": false
        }
    ],
    "type": "single"
...
{
    "question": "Какие методы интерполяции относятся к методам глобальной интерполяции?",
    "answers": [
        {
            "text": "Полиномы Лагранжа.",
            "correct": true
        },
        {
            "text": "Первая и вторая формулы Ньютона.",
            "correct": true
        },
        {
            "text": "Интерполяция кубическими сплайнами.",
            "correct": false
        },
        {
...
{
    "question": "Какой вид интерполяции является простейшим и представляет собой соединение соседних точек отрезками прямых?",
    "answers": [
        {
            "text": "Линейная интерполяция.",
            "correct": true
        ...
        {
            "text": "Интерполяция полиномом Лагранжа.",
            "correct": false
        },
        {
            "text": "Интерполяция кубическими сплайнами.",
        ...
        {
            "text": "Интерполяция по соседним точкам.",
            "correct": false
        }
    ],
    "type": "single"
...
{
    "question": "Какие причины делают нежелательным использование глобальной интерполяции полиномом высокой степени?",
    "answers": [
        {
            "text": "При вычислении полинома высокой степени могут накапливаться ошибки округления.",
            "correct": true
        },
        {
            "text": "Интерполяционный полином может плохо приближать исходную функцию.",
            "correct": true
        },
        {
            "text": "Задача интерполяции может быть плохо обусловлена (полином чувствителен к возмущениям значений в узлах).",
            "correct": true
        },
        {
            "text": "Полином высокой степени всегда дает более точный результат.",
            "correct": false
        }
    ],
    "type": "multiple"
...
{
    "question": "Почему сплайны более высокого порядка, чем третий, используются редко?",
    "answers": [
        {
            "text": "При вычислении большого числа коэффициентов может накапливаться погрешность, приводящая к значительным отклонениям.",
            "correct": true
        },
        {
            "text": "Кубические сплайны уже обеспечивают достаточную гладкость и минимальную кривизну.",
            "correct": true
        },
        {
            "text": "Сплайны высокого порядка слишком сложны в программировании.",
            "correct": false
        },
        {
            "text": "Сплайны высокого порядка не обладают гладкостью.",
            "correct": false
        }
    ],
    "type": "multiple"
...
`,
	"test": {
	  ...
	  {
    "question": "Какие два класса численных методов решения задачи Коши существуют?",
    "answers": [
        {
            "text": "Одношаговые методы (требуют информацию об одном предыдущем шаге).",
            "correct": true
        },
        {
            "text": "Многошаговые методы (требуют информацию более чем об одной предыдущей точке).",
            "correct": true
        },
        {
            "text": "Аналитические методы (дают точное решение в виде формулы).",
            "correct": false
        }
    ],
    "type": "multiple"
...
{
    "question": "Почему многошаговыми методами нельзя начать решать задачу Коши?",
    "answers": [
        {
            "text": "Потому что для них требуется информация о нескольких предыдущих точках, которых в начале вычислений ещё нет.",
            "correct": true
        },
        {
            "text": "Потому что они менее точные, чем одношаговые методы.",
            "correct": false
        },
        {
            "text": "Потому что они всегда требуют большего шага интегрирования.",
            "correct": false
        }
    ],
    "type": "single"
...
{
    "question": "Как решаются дифференциальные уравнения высших порядков при использовании численных методов?",
    "answers": [
        {
            "text": "Сведением к системе уравнений первого порядка путем замены переменных.",
            "correct": true
        },
        {
            "text": "Непосредственным применением методов Рунге-Кутты к уравнению высшего порядка.",
            "correct": false
        },
        {
            "text": "Использованием специальных формул только для уравнений высших порядков.",
            "correct": false
        }
    ],
    "type": "single"
...
{
    "question": "Что называется порядком обыкновенного дифференциального уравнения?",
    "answers": [
        {
            "text": "Максимальный порядок входящей в него производной (или дифференциала).",
            "correct": true
        },
        {
            "text": "Количество произвольных постоянных в общем решении.",
            "correct": false
        },
        {
            "text": "Степень полинома, аппроксимирующего решение.",
            "correct": false
        }
    ],
    "type": "single"
...
{
    "question": "Что называется интегральной кривой в контексте дифференциальных уравнений?",
    "answers": [
        {
            "text": "График частного решения дифференциального уравнения.",
            "correct": true
        },
        {
            "text": "Семейство всех решений дифференциального уравнения.",
            "correct": false
        },
        {
            "text": "Линия, соединяющая точки экспериментальных данных.",
            "correct": false
        }
    ],
    "type": "single"
...
`,
	"test": {
	  ...
	  {
    "question": "В каких случаях применяется численное дифференцирование?",
    "answers": [
        {
            "text": "Когда функцию трудно или невозможно продифференцировать аналитически.",
            "correct": true
        },
        {
            "text": "Когда функция задана не формулой, а таблицей значений.",
            "correct": true
        },
        {
            "text": "Когда функция задана аналитической формулой и легко дифференцируется.",
            "correct": false
        }
    ],
    "type": "multiple"
...
{
    "question": "Какой основной подход используется при построении формул численного дифференцирования?",
    "answers": [
        {
            "text": "Аппроксимация функции другой функцией, производная которой легко вычисляется.",
            "correct": true
        },
        {
            "text": "Аналитическое дифференцирование исходной функции.",
            "correct": false
        },
        {
            "text": "Построение интерполяционного полинома или сплайна с последующим его дифференцированием.",
            "correct": true
        }
    ],
    "type": "multiple"
...
{
    "question": "Почему центральная разность точнее, чем разности вперед и назад, при одинаковом шаге h?",
    "answers": [
        {
            "text": "Потому что погрешность центральной разности имеет порядок h², а погрешность разностей вперед и назад — порядок h.",
            "correct": true
        },
        {
            "text": "Потому что центральная разность использует значения функции с обеих сторон от точки.",
            "correct": true
        },
        {
            "text": "Потому что центральная разность требует меньше вычислений.",
            "correct": false
        }
    ],
    "type": "multiple"
...
{
    "question": "В каких точках нельзя использовать центральную разность для вычисления производной?",
    "answers": [
        {
            "text": "На границах отрезка (в точках x = a или x = b).",
            "correct": true
        },
        {
            "text": "Во всех внутренних точках отрезка.",
            "correct": false
        },
        {
            "text": "В точках, где функция не определена.",
            "correct": false
        }
    ],
    "type": "single"
...
{
    "question": "Как влияет уменьшение шага h на погрешность численного дифференцирования при наличии погрешности в значениях функции?",
    "answers": [
        {
            "text": "Погрешность, связанная с неточностью значений функции, неограниченно возрастает при уменьшении h.",
            "correct": true
        },
        {
            "text": "Погрешность всегда уменьшается при уменьшении h.",
            "correct": false
        },
        {
            "text": "Существует оптимальное значение h, при котором общая погрешность минимальна.",
            "correct": true
        }
    ],
    "type": "multiple"
...
`,
    ...
    "question": "В чём заключается общий подход к численному интегрированию?",
    "answers": [
        {
            "text": "Интервал интегрирования разбивается на множество меньших интервалов, затем находятся площади фигур под графиком функции и суммируются.",
            "correct": true
        },
        {
            "text": "Вычисляется первообразная функция аналитически, затем подставляются пределы интегрирования.",
            "correct": false
        },
        {
            "text": "Подынтегральная функция заменяется на константу, равную её среднему значению на отрезке.",
            "correct": false
        }
    ],
    "type": "single"
...
{
    "question": "Какие существуют методы численного интегрирования в зависимости от способа вычисления подынтегральной суммы?",
    "answers": [
        {
...
{
    "question": "Какой метод численного интегрирования является наиболее простым, но при этом и наиболее грубым?",
    "answers": [
        {
            "text": "Метод прямоугольников.",
            "correct": true
...
{
    "question": "Какое требование предъявляется к количеству отрезков разбиения при использовании метода парабол (Симпсона)?",
    "answers": [
        {
            "text": "Количество отрезков разбиения должно быть чётным.",
            "correct": true
        },
        {
            "text": "Количество отрезков разбиения должно быть нечётным.",
            "correct": false
        },
        {
            "text": "Количество отрезков разбиения должно быть кратным трём.",
            "correct": false
        }
    ],
    "type": "single"
...
{
    "question": "В чём заключается преимущество способа вычисления интеграла с автоматическим выбором шага?",
    "answers": [
        {
            "text": "Метод приспосабливается к особенностям подынтегральной функции: в областях резкого изменения функции шаг уменьшается, а там, где функция изменяется слабо — увеличивается.",
            "correct": true
        },
        {
            "text": "Метод всегда использует максимально возможный шаг для ускорения вычислений.",
            "correct": false
        },
        {
            "text": "Метод не требует задавать начальное приближение.",
            "correct": false
        }
    ],
    "type": "single"
